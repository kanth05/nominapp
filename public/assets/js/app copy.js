        ...
        languageDropdown: function() {
            ...
            for (var i = 0; i < getDropdownElement.length; i++) {
                getDropdownElement[i].addEventListener('click', function() {
                    document.querySelectorAll('.more-dropdown .dropdown-toggle > img')[0].setAttribute('src', './public/assets/img/' + this.getAttribute('data-img-value') + '.png' );
                })
            }
        },
    }
            ...
            if (!$(Selector.getBody).hasClass('single-page')) {
                ...
                if ($(Selector.getBody).hasClass('dashboard-analytics')) {
                    ...
                    $('#minimal').on('click', function(event) {
                        ...
                        console.log(2);
                        /* Act on the event */
                        $html = '<link href="/nominApp/public/assets/css/dashboard/dash_1-minimal.css" rel="stylesheet" type="text/css" class="dashboard-analytics-minimal" />';
                    ...
                    $('#minimal').on('click', function(event) {
                        ...
                        $html = '<link href="/nominApp/public/assets/css/dashboard/dash_2-minimal.css" rel="stylesheet" type="text/css" class="dashboard-sales-minimal" />';
                ...
                $('#minimal').on('click', function(event) {
                    event.preventDefault();
                    /* Act on the event */
                    $html = '<link href="/nominApp/public/assets/css/structure-minimal.css" rel="stylesheet" type="text/css" class="structure-minimal" />';
