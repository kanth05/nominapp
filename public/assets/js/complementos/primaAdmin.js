$(document).ready( function(){
    ...
    const eventos = () => {
        ...
        let myForm = document.getElementById('prima-admin');

        myForm.addEventListener('submit', (e) => {
            
            e.preventDefault();
            let ipAPI = 'http://localhost/nominApp/tabulador/editarPrimaAdmin';
            let data = new FormData(myForm);
            swal.queue([{
                title: 'Edición de prima personal administrativo',
